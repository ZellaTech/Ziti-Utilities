...
function RunGetCurrentEnv ($GetTypes="ALL") {
    ...
    @@ -213,15 +205,13 @@ function RunGetCurrentEnv ($GetTypes="ALL") {
...
function RunGetTasks ($InputArgs, $REQType) {
    ...
    @@ -233,32 +223,24 @@ function RunGetTasks ($InputArgs, $REQType) {
...
function DownloadInstall {
    ...
    @@ -369,17 +339,14 @@ function DownloadInstall {
    ...
    @@ -423,31 +387,24 @@ function DownloadInstall {
